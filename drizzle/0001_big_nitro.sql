ALTER TABLE `delivery_values` DROP PRIMARY KEY;--> statement-breakpoint
...
ALTER TABLE `notifications` MODIFY COLUMN `created_at` timestamp(3) DEFAULT (now());--> statement-breakpoint
ALTER TABLE `orders` MODIFY COLUMN `created_at` timestamp(3) DEFAULT (now());--> statement-breakpoint
...
ALTER TABLE `notifications` ADD `author` varchar(255) NOT NULL;--> statement-breakpoint
ALTER TABLE `delivery_values` ADD PRIMARY KEY(`id`);--> statement-breakpoint
