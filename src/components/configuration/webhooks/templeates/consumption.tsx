...
export const CONSUMPTION_TEMPLEATE_FIELDS = {
    'employee-name': 'Nome do Vendedor',
    items: 'Lista de Items'
}

type ConsumptionWebhookTempleateProps = {
    webhook: {
        id: string
        image: string | null
        title: string | null
...
export default function ConsumptionWebhookTempleate({
    webhook
}: ConsumptionWebhookTempleateProps) {
                    ...
                    <div className="flex min-h-full items-center justify-center p-4">
                        <Dialog.Panel className="flex w-full max-w-3xl flex-col items-center rounded bg-zinc-800 p-5 text-white">
                            <Dialog.Title className="mb-5 text-xl font-semibold">
                                Customizando Webhook de Consumo
                            </Dialog.Title>
